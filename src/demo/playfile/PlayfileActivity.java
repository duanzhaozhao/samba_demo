...
public class PlayfileActivity extends Activity implements OnItemClickListener
{
	...
	private void init()
	{
		...
		dialog.setMessage("ï¿½ï¿½ï¿½ï¿½Å¬ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½...");
	...
	class SearchTask extends AsyncTask<String, Void, Void>
	{
		...
		protected Void doInBackground(String... params)
		{
			...
			try
			{
				...
				for (SmbFile f : fs)
				{
					if (f.isDirectory())//ÊÇÎÄ¼þ¼Ð
					{
						dirList.add(f);
					}
					else
					{
						fileList.add(f);//ÊÇÎÄ¼þ
					}
				}
		...
		protected void onPostExecute(Void result)
		{
			...
			{
				Toast.makeText(PlayfileActivity.this, "ï¿½ï¿½ï¿½ï¿½Ê§ï¿½ï¿½ï¿½Ë£ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ ",
